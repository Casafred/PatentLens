...
(function () {
  ...
  // 单张附图的内联操作工具栏：无需点开大图即可旋转/缩放。
  function figureToolbarHtml() {
    return '<div class="fig-toolbar" role="toolbar" aria-label="附图操作"><button type="button" data-fig-action="zoom-out" title="缩小">−</button><button type="button" data-fig-action="zoom-in" title="放大">＋</button><button type="button" data-fig-action="reset" title="重置">100%</button><button type="button" data-fig-action="rotate-left" title="向左旋转">↶</button><button type="button" data-fig-action="rotate-right" title="向右旋转">↷</button><span class="fig-scale">100%</span></div>';
  }
