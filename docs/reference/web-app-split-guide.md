...
> **历史参考提示（2026-07-31）：** 本手册的全局变量清单、行号和“可安全移出”范围已过期。执行拆解前必须以 [`../web-app-refactor-plan-2026-07-31.md`](../web-app-refactor-plan-2026-07-31.md) 重新生成依赖清单；当前产品只维护 Electron，不扩展 Tauri 分支。
